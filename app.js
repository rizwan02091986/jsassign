...
let urdu = Number(prompt("Enter The Urdu Marks", ""));
let english = Number(prompt("Enter The English Marks", ""));
let islamiat = Number(prompt("Enter The Islamiat Marks", ""));
let computer = Number(prompt("Enter The Computer Marks", ""));
